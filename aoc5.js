...
let p10 = {
	...
	solveFor: function(jumps) {
		...
		while (curr >= 0 && curr < jumps.length) {
			...
			let lastIndex = curr;
			curr += jumps[curr];
			jumps[lastIndex] += (jumps[lastIndex] < 3)? 1: -1;
		}
